...
# ⚙️ 3x6 矩阵组图配置区
# =================================================================
TARGET_TIME_STRS = ["20230716_221000", "20230716_231000", "20230717_001000"]
ROW_LABELS = ["2023-07-16\n22:10 UT", "2023-07-16\n23:10 UT", "2023-07-17\n00:10 UT"]
...
def main():
    ...
    res_ticks = [t for t in range(0, int(global_res_vmax) + 10, 20) if t <= global_res_vmax]
    diff_ticks = [t for t in range(-120, 121, 20) if global_diff_vmin <= t <= global_diff_vmax]
    ...
    for row, t_str in enumerate(TARGET_TIME_STRS):
        ...
        ax_cb_diff.axis('off')
        cax_diff = inset_axes(ax_cb_diff, width="30%", height="88%", loc='center left', borderpad=0)
    ...
    save_path = os.path.join(OUTPUT_DIR, "magstorm_period_matrix_analysis.png")
